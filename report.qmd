...
![](outputs/figures/outliers_2024.png)

## Municipal-level map without outliers

![](outputs/figures/ratio_2024_no_outliers.png)
...
where:
- $begin:math:text$M\_i$end:math:text$ is the set of municipalities belonging to autonomous community $begin:math:text$i$end:math:text$;
- $begin:math:text$r\_j$end:math:text$ is the municipal HSE proxy;
- $begin:math:text$s\_j$end:math:text$ is the municipal total urban surface.

![](outputs/figures/ratio_2024_ccaa.png)
...
![](outputs/figures/hse_variation_municipal.png)

## Autonomous community variation

![](outputs/figures/hse_variation_ccaa.png)
...
where $begin:math:text$X\_\{it\}$end:math:text$ represents either built surface or total urban surface.

## Built surface

### Municipal level

![](outputs/figures/built_variation_municipal.png)

### Autonomous community level

![](outputs/figures/built_variation_ccaa.png)

# Total urban surface

## Municipal level

![](outputs/figures/totsurf_variation_municipal.png)

## Autonomous community level

![](outputs/figures/totsurf_variation_ccaa.png)
